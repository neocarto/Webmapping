...
⚠️ <ins>Normalement, on ne réalise par de cartes choroplethes avec des données quantitatives absolues !!! </ins>
...
Avec Leaflet, on peut faire beaucoup de choses. Et il existe beaucoup d'exemples en ligne. Par contre, ca necessite de savoir coder. Il n'y a pas de types de cartes thématiques clé en main à Et c'est assez verbeux. Heureusement, il existe d'autres solutions.
...
- Vous avez à disposition la variable `"population"` (quanti abs) et la variable `"density"` (quanti rel).
