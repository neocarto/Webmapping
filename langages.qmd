...
```{.js .custom-js}
// On va chercher un ficher js directement en ligne. Nous expliquerons fetch et then plus tard.
fetch("https://raw.githubusercontent.com/neocarto/Webmapping/refs/heads/main/data/cities.json")
  ...
  .then(data => {
    ...
    // Filtrez pour le conserver que les villes de plus de 500 millions 

    //Parmi celles-ci, combien y en a t-il dans l'hémisphère Nord ? 
